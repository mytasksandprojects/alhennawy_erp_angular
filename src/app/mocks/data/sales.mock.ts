...
export const MOCK_WORK_ORDERS: SalesWorkOrder[] = [
  ...
  { id: 'wo-3', number: 'SO-2026-0120', date: daysAgo(0), channel: 'local', customerCode: 'CUS-021', customerName: 'الشركة الحديثة للورق الصحي', itemCode: 'FIN-NPK-18', itemName: 'نابكن سادة ج ١٨', quantityKg: 9000, sizeMm: 250, status: 'warehouse-check', availableFromStockKg: 0, toProduceKg: 9000, currency: 'EGP', exchangeRate: 1, agreedPrice: 29.25, collectionStatusKey: 'sales.collection.pending' },
...
export const MOCK_EXPORT_ORDERS: ExportOrder[] = [
  { id: 'eo-1', number: 'EXP-2026-0031', customerCode: 'CUS-EXP-03', customerName: 'Napoli Tissue S.r.l.', stage: 'logistics', rollsCount: 96, containersCount: 2, productionDeadline: daysAhead(4), loadingDate: daysAhead(7), totalUsd: 40480 },
  { id: 'eo-2', number: 'EXP-2026-0032', customerCode: 'CUS-EXP-07', customerName: 'Amman Hygiene Co.', stage: 'proforma', rollsCount: 48, containersCount: 1, totalUsd: 19800 },
  { id: 'eo-3', number: 'EXP-2026-0030', customerCode: 'CUS-EXP-03', customerName: 'Napoli Tissue S.r.l.', stage: 'invoiced', rollsCount: 96, containersCount: 2, loadingDate: daysAgo(9), eInvoiceNumber: 'EINV-88412', totalUsd: 39875 },
];
