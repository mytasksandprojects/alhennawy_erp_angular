...
export const MOCK_TICKETS: WeighingTicket[] = [
  {
    ...
    partyCode: 'SUP-001',
    partyName: 'شركة اليسر للزيوت و الشحوم',
    itemCode: 'DSH-001',
  ...
  },
  {
    ...
    itemName: 'ورق دشت درجة أولى',
    firstWeightKg: 23800,
    firstWeighedAt: hoursAgo(48),
    secondWeightKg: 9050,
    secondWeighedAt: hoursAgo(46),
    netWeightKg: 14750,
    priced: true,
  },
  {
    ...
    partyCode: 'CUS-001',
    partyName: 'العالمية للورق الصحي',
    itemCode: 'FIN-SMP-22',
  ...
  },
  {
    ...
    driverName: 'سيد فتحي',
    partyCode: 'SUP-021',
    partyName: 'مؤسسة الشرق للتجارة و التوريدات',
    itemCode: 'DSH-002',
