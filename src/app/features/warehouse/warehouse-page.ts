...
import {
  ITEM_CARD_COLUMNS,
  ITEM_CARD_FILTERS,
  ITEM_MOVEMENT_COLUMNS,
  ITEM_MOVEMENT_FILTERS,
} from './warehouse-reports.columns';
import {
  ITEM_GROUP_COLUMNS,
  ITEM_GROUP_FIELDS,
...
export class WarehousePage {
  protected readonly tabs: ListTabConfig[] = [
    ...
    {
      id: 'itemMovement',
      labelKey: 'warehouse.reports.itemMovement',
      endpoint: API_ENDPOINTS.warehouse.itemMovement,
      columns: ITEM_MOVEMENT_COLUMNS,
      filters: ITEM_MOVEMENT_FILTERS,
      readOnly: true,
    },
    {
      id: 'itemCard',
      labelKey: 'warehouse.reports.itemCard',
      endpoint: API_ENDPOINTS.warehouse.itemCard,
      columns: ITEM_CARD_COLUMNS,
      filters: ITEM_CARD_FILTERS,
      readOnly: true,
    },
    {
      id: 'itemGroups',
    ...
    {
      id: 'custody',
      labelKey: 'warehouse.tabs.custody',
      endpoint: API_ENDPOINTS.warehouse.custody,
      columns: TOOL_CUSTODY_COLUMNS,
      fields: TOOL_CUSTODY_FIELDS,
    },
    {
      id: 'counts',
      labelKey: 'warehouse.tabs.counts',
      endpoint: API_ENDPOINTS.warehouse.counts,
      columns: STOCK_COUNT_COLUMNS,
      fields: STOCK_COUNT_FIELDS,
    },
    {
      id: 'purchaseRequests',
