...
export const EMPLOYEE_COLUMNS: TableColumn[] = [
  ...
  {
    key: 'roleId',
    labelKey: 'hr.fields.role',
    type: 'badge',
    keyPrefix: 'roles.',
    badgeToneMap: { admin: 'info', finance: 'success', store: 'warning', operator: 'neutral' },
  },
  { key: 'workStart', labelKey: 'hr.fields.workStart', align: 'center' },
  { key: 'workEnd', labelKey: 'hr.fields.workEnd', align: 'center' },
...
export const EMPLOYEE_FIELDS: FormField[] = [
  ...
  { key: 'roleId', labelKey: 'hr.fields.role', type: 'select', lookup: 'roles' },
  { key: 'workStart', labelKey: 'hr.fields.workStart', type: 'time' },
  { key: 'workEnd', labelKey: 'hr.fields.workEnd', type: 'time' },
