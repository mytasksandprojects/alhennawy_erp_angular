...
export class HrPage {
  protected readonly tabs: ListTabConfig[] = [
    ...
    {
      id: 'administrations',
      labelKey: 'hr.tabs.administrations',
      endpoint: API_ENDPOINTS.hr.administrations,
      columns: ADMINISTRATION_COLUMNS,
      fields: ADMINISTRATION_FIELDS,
    },
    {
      id: 'sections',
      labelKey: 'hr.tabs.sections',
      endpoint: API_ENDPOINTS.hr.sections,
