...
export function workOrderColumns(showPrices: boolean): TableColumn[] {
  const columns: TableColumn[] = [
    ...
    { key: 'parentFamily', labelKey: 'qc.fields.parent', type: 'key' },
...
export const WORK_ORDER_FIELDS: FormField[] = [
  ...
  { key: 'productName', labelKey: 'qc.fields.productName' },
  { key: 'parentFamily', labelKey: 'qc.fields.parent', type: 'select', lookup: 'qcParents' },
  { key: 'ply', labelKey: 'qc.fields.ply', type: 'select', lookup: 'qcPly', filterBy: 'parentFamily' },
