...
/** BRD dashboard shown on that report’s own page — never on the hub. */
export const REPORT_DASHBOARD: Record<string, string> = {
  workOrders: 'sales',
  exportOrders: 'sales',
  invoices: 'sales',
  customers: 'sales',
  ...
  medicines: 'clinic',
  dispenses: 'clinic',
  chemOutput: 'chemicals',
  chemStaff: 'chemicals',
  chemRaw: 'chemicals',
  chemOps: 'chemicals',
  chemMovements: 'chemicals',
  chemAccounts: 'chemicals',
};
